...
export function ViewMainModal(buttonPopup, setButtonPopup, currentUserID, isCurrent) {
...
function ProfileImage(show) {
  console.log("this is show", show.show)
  const [buttonPopup, setButtonPopup] = useState(show.show)
  const [userProfilePicUrl, setUserProfilePicUrl] = useState('')
  ...
  return (
    <div className="ProfileImage">
      <main>
        ...
        <div>
          {ViewMainModal(buttonPopup, setButtonPopup, useAuth().currentUser.uid, true)}
        </div>
