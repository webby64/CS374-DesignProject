...
export default function Dashboard() {
    ...
    return (
        <Container style = {{"height" : "100vh", "width" : "100%", "margin" : "0", "padding" : "0"}} fluid>
            <Row>
                <Col md={{span: 1}} style={{"marginTop" : "10px", "marginLeft" : "50px"}}> <Button onClick = {handleLogout} onMouseEnter = {() => setLogOutBorder("red")} onMouseLeave = {() => setLogOutBorder("white")} style = {{"backgroundColor" : "transparent", "borderRadius" : "50%", "borderColor" : `${logOutBorder}`, "width" : "80px", "height" : "80px", "display" : "flex", "padding" : "0", "justifyContent" : "center", "alignItems" : "center", "border" : "5px solid white", "color":"black"}}> <strong>Log Out </strong> </Button></Col>
                ...
                <Col md={{span: 1}} style={{"marginTop" : "10px", "marginLeft" : "100px"}}>{fetched && groupIsFull &&< ProfileImage show = {false}/>} <div style = {{'marginLeft' :'10px', "fontWeight":'bold'}}>My Page</div></Col>         
            </Row>
            {groupIsFull && fetched ? 
                <Row>
